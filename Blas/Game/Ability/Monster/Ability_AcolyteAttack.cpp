...
void Ability_AcolyteAttack::OnHitCheck()
{
    ...
    float damage = DAMAGE_MULT * GetStatComponent()->GetCurrent(EStatType::AttackPower);
    CombatHelper::ApplyDamageInBox(owner, center, GetTraceSize(), {ELayer::Player}, damage, hitResults);
}
