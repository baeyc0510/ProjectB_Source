...
void SoundManager::PlayOnce(SoundResource* sound, float volume)
{
	FMOD_RESULT result;
...
void SoundManager::PlayLoop(const wstring& soundName, SoundResource* sound, float volume)
{
...
void SoundManager::Stop(const wstring& soundName)
{
	FMOD::Channel* channel = ChannelFind(soundName);
	if (nullptr == channel)
		return;
...
void SoundManager::Pause(const wstring& soundName)
{
	FMOD::Channel* channel = ChannelFind(soundName);
	if (nullptr == channel)
		return;
...
void SoundManager::Resume(const wstring& soundName)
{
	FMOD::Channel* channel = ChannelFind(soundName);
	if (nullptr == channel)
		return;
...
FMOD::Channel* SoundManager::ChannelFind(const wstring& soundName)
{
