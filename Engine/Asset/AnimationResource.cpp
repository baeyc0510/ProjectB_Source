...
void AnimationResource::Load(const wstring& key, const wstring& path)
{
...
void AnimationResource::Create(ImageResource* image, float stepTime, UINT count, bool repeat, Vec2 pos, Vec2 scale, Vec2 step)
{
	this->image = image;
	this->repeat = repeat;
